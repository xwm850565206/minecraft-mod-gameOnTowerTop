...
public class ModelSwordSkeleton extends ModelBiped
{
    public ModelSwordSkeleton()
    {
        this(0.0F, false);
    }

    public ModelSwordSkeleton(float modelSize, boolean p_i46303_2_)
    {
    ...
    public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime)
    {
        ...
        if (itemstack.getItem() == Items.BOW && ((EntityTowerSkeleton)entitylivingbaseIn).isSwingingArms())
        {
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn)
    {
        ...
        EntitySwordSkeleton entitySwordSkeleton = (EntitySwordSkeleton)entityIn;

        if (entitySwordSkeleton.isSwingingArms() && (itemstack.isEmpty() || itemstack.getItem() != Items.BOW))
        {
